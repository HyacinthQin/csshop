...
public class WeiXinUserUtil {
	...
	public static void getCode() throws UnsupportedEncodingException {
		// String codeUrl =
		// "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx202abfb5363f2c4d&redirect_uri="
		// + URLEncoder.encode("bcb46787.ngrok.io", "utf-8")
		// +
		// "&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect";
		//String codeurl="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx202abfb5363f2c4d&redirect_uri=http://bcb46787.ngrok.io/csshop/wechatlogin/logincheck&user_type=1&response_type=code&scope=snsapi_userinfo&state=1#wechat_redirect";
	}
